...
<!-- exploreFoodCategoriesSectionStarts -->
    <section class="food-menu">
    <div class="container">
    <h2 class="sectionalHeading text-center">Food Categories</h2>
    ...
    if ($count_categories > 0) {
        // foodAvailable
        while ($rows = mysqli_fetch_assoc($res_categories)) {
        ...
        // imageAvailable
             ...
             ?>
<img class="card-img-top-catgeries" src="<?php echo HOMEURL; ?>images/category/<?php echo $image_name; ?>" alt="<?php echo $title; ?>" >
                            <?php
        } ?>
        </div>
        </a>
    ...
    <!--  exploreFoodCategoriesSectionEnds -->

      <!-- foodMenuSectionStartsHere -->
      <section class="food-menu">
    <div class="container">
    <h2 class="sectionalHeading text-center">Food Menu</h2>
