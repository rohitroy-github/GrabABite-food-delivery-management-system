            ...
            <div class="row">
                <div class="col-md-8 submitDetailsContainer">
                    <form class="form-container" action="" method="POST">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn adminPanelBtn" name="submit">Place Order</button>
                        </div>
                        ...
                        <?php if (isset($_POST['submit'])) {
                            ...
                            if ($res_order == true) {
                                ...
                                $_SESSION['order-not-placed'] =
                                    "<p class='text-center'>Order was not placed successfully, please try again later !</p>";
                                // header('location:' . HOMEURL);
                            }
                        } ?>
                    </form>
